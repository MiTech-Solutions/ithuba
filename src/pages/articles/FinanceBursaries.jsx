  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="twitter:title" content="Best Bursaries for Accounting & Finance Students | Ithuba" />
        <meta name="twitter:description" content="The best South African bursaries for accounting and finance students — banks, audit firms and insurers." />
