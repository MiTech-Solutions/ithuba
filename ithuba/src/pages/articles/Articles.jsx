...
export const articles = [
  ...
  {
    path: "/articles/bursaries-with-no-closing-date",
    title: "Bursaries you can apply for with no closing date in South Africa",
    description: "Find South African bursaries with rolling or no fixed closing date — programmes you can apply to any time of year, plus what to do if you've missed all the main deadlines.",
    tag: "Funding Guide",
    readTime: "6 min read",
    featured: false,
  },
  {
    path: "/articles/merit-scholarship-vs-need-based-scholarship",
    title: "Merit scholarship vs need-based scholarship — what's the difference?",
    description: "A detailed comparison of merit and need-based scholarships in South Africa — eligibility, competitiveness, examples, and which type to prioritise in your applications.",
    tag: "Comparison",
    readTime: "7 min read",
    featured: false,
  },
